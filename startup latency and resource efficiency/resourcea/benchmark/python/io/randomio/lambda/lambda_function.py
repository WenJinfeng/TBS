...
def handler(event, context):
    ...
    print("execute duration: " + json.dumps({'disk_write_bandwidth':disk_write_bandwidth,'disk_write_latency':disk_write_latency,'disk_read_bandwidth':disk_read_bandwidth,'disk_read_latency':disk_read_latency}))
