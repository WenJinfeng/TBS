...
public final class AzureUtil {
    ...
    public static void createCertificate(String certPath, String pfxPath,
        ...
        AzureUtil.cmdInvocation(commandArgs, false);
        ...
        if (pfxFile.exists()) {
            ...
            AzureUtil.cmdInvocation(certCommandArgs, true);
    ...
    public static void uploadFileToFunctionApp(PublishingProfile profile, String fileName, InputStream file) {
        ...
        try {
            System.out.println("ftp server: " + server);
            System.out.println("ftp profile.ftpUsername(): " + profile.ftpUsername());
            System.out.println("ftp profile.ftpPassword(): " + profile.ftpPassword());
            ftpClient.connect(server);
            boolean login = ftpClient.login(profile.ftpUsername(), profile.ftpPassword());
            ...
            boolean store = ftpClient.storeFile(fileName, file);
    ...
    /**
     * Uploads a file to an Azure web app.
     * profile the publishing profile for the web app.
     * fileName the name of the file on server
     * file the local file
     */
